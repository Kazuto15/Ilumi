...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/popper.js@2.11.6/dist/umd/popper.min.js" integrity="sha384-2KJ7ibI5Zo7R7vPBRs3fU7ccQU5SEx6tFzs1Nw9g+uklDuvhqq9biZciX10QNPdP" crossorigin="anonymous"></script>
        ...
        <div class="box-illumi">
            <div class="item-1">
                <div class="textos">
                    ...
                    <div class="criatividade-unique">
                        <div class="criatividade">
                            <p>Unindo criatividade e expertise para criar
                                soluções excepcionais e iluminar o caminho
                                para um futuro digital brilhante.</p>
                        </div>
                    </div>

                    <div class="comece-unique">
                        <div class="comece">
                            <p>Comece</p>
                        </div>
                    </div>
            ...
            <div class="item-2">
                <div class="box-imagem">
                    <img src="./../img/homemNote01.png" alt="" class="img-note">
                </div>
            </div>
        </div>
            ...
            <div class="faixa-texto">
                <div class="texto-faixa">
                    <p>Conheça nossa equipe diversificada e apaixonada, unida pela busca incessante da
                        excelência. Com especialistas em tecnologia de ponta, fomentamos a inovação,
                        celebramos a diversidade e, juntos, moldamos o futuro digital com paixão e
                        expertise. Na ILLUMI, cada membro é uma peça-chave na nossa jornada para iluminar
